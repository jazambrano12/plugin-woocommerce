...
class WC_Correios_Shipping_Legacy extends WC_Shipping_Method {
	...
	public function __construct() {
		$this->id                 = 'correios';
		$this->method_title       = __( 'BlueX', 'woocommerce-correios' );
		$this->method_description = __( 'BlueX is a Chile delivery method.', 'woocommerce-correios' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'login' => array(
				...
				'type'             => 'text',
				'description'      => __( 'Your BlueX login.', 'woocommerce-correios' ),
				'desc_tip'         => true,
			),
			'password' => array(
				'title'            => __( 'Administrative Password', 'woocommerce-correios' ),
				'type'             => 'password',
				'description'      => __( 'Your BlueX password.', 'woocommerce-correios' ),
				'desc_tip'         => true,
			),
			'service_pac' => array(
