...
class WC_Correios_TrackingEmail extends WC_Email {
	...
	public function __construct() {
		...
		$this->title            = __( 'BlueX Tracking Code', 'woocommerce-correios' );
		...
		$this->subject          = __( '[{site_title}] Your order {order_number} has been sent by BlueX', 'woocommerce-correios' );
		$this->message          = __( 'Hi there. Your recent order on {site_title} has been sent by BlueX.', 'woocommerce-correios' )
									. PHP_EOL . ' ' . PHP_EOL
									. __( 'To track your delivery, use the following the tracking code(s): {tracking_code}', 'woocommerce-correios' )
									. PHP_EOL . ' ' . PHP_EOL
									. __( 'The delivery service is the responsibility of the BlueX, but if you have any questions, please contact us.', 'woocommerce-correios' );
