...
//			return;
		...
		// Display delivery.
		$meta_delivery = array();
		$str = strtotime(date("M d Y ")) - (strtotime(implode('-', array_reverse(explode('/', $shipping->PrazoEntrega)))));
		$dDiff = floor($str/3600/24)*-1;

		$meta_delivery = array(
			'_delivery_forecast' => $dDiff //$shipping->PrazoEntrega
		);
